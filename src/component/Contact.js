...
const Contact = () => {
  return (
    <div className="flex flex-col md:flex-row sm:flex-row h-auto w-full items-center justify-end mt-5 pt-[160px] mx-auto   md:w-[75%] sm:w-[90%]">
      {/* imaghe */}
      <div>
      ...
      {/* contact details */}
      <div
        className=" border-2 rounded-2xl w-full h-auto    p-10 flex flex-col gap-4 m-5   ads custom-scale
"
      >
